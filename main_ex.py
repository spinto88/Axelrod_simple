...
for configuracion in range(0,100):
    ...
    for Q in range(10,200,20):
        for campo in range(0,100,1):
            ...
            mysys.opinion_included = 0    #incluir la opinion en la homofilia
            mysys.phi = phi
            ...
            name2 = 'Exc_distribucion_no_vac_phi' + str(phi) + '_q' + str(Q)
            fp = open(name2,'a')
